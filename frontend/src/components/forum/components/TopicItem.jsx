  ...
  return (
    <div className="bg-white/60 border border-gray-300 rounded-lg p-4 flex items-start gap-4 transition-shadow hover:shadow-lg">
      ...
      <img 
        ...
        onError={(e) => { e.target.onerror = null; e.target.src='https://placehold.co/40x40/EFE2D3/000000?text=U'; }}
      />
      ...
      <div className="flex-grow">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <span className="text-xs text-gray-500 ml-2">@{topic.username}</span>
          </div>
        ...
        {/* Judul Topik */}
        <h3 className="text-lg font-bold my-1 cursor-pointer hover:underline text-gray-800">
          {topic.title}
        </h3>
